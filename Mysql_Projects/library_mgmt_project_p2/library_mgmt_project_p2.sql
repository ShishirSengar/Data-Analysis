-- Library Management System project p2
...
as
select b.isbn, b.book_title, count(ist.issued_id) as num_of_books_issued from books as b
...
select * from members where reg_date >= now() - interval 180 day ;
...
-- Task 10. Create a Table of Books with Rental Price Above a Certain Threshold (7 USD):
create table expensive_books
as
select * from books where rental_price > 7.0;
